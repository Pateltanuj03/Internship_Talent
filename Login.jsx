...
export default class LoginForm extends React.Component {
  ...
  login() {
    ...
    $.ajax({
      url:
        "https://talentserviceidentity.azurewebsites.net/authentication/authentication/SignIn",
      type: "POST",
  ...
  render() {
    let isEmailVerified = this.state.isEmailVerified ? (
      <div>
        <form
          className={`ui large form ${this.isFormValid()} ${this.isLoadingChange()}`}
    ...
    return <span>{isEmailVerified}</span>;
  }
}
{
  /*
